                ...
                <div className='produtos-cardapio'>
                    <tr className='cardapio-linha'>
                        <td className='cardapio-celula'>
                            <div className="inforacoes__produto">
                                <div className="inforacoes__produto__texto">
                                    <p>Nome do Produto</p>
                                    <p className="desc-produto-cardapio">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy</p>
                                </div>
                            ...
                            <div className="inforacoes__produto__valores">
                        ...
                        <td className='cardapio-celula'>
                            <div className="inforacoes__produto">
                                <div className="inforacoes__produto__texto">
                                    <p>Nome do Produto</p>
                                    <p className="desc-produto-cardapio"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy</p>
                                </div>
                                <img className="imagemProduto" src="https://receitinhas.com.br/wp-content/uploads/2022/06/cachorro-quente-tradicional-730x365.jpg" />
                            </div>
                            <div className="inforacoes__produto__valores">
